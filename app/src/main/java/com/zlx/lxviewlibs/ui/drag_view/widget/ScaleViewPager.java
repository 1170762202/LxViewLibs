package com.zlx.lxviewlibs.ui.drag_view.widget;
...
*@description: 只有y轴运动才能放大缩小屏幕，往y轴方向 向上提是放大或者不变，往y轴方向 向下拉是缩小，或者缩小到极限
*
*/
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getActionMasked()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                Log.e("TAG", "ACTION_CANCEL: " + currentStatus);
                if (currentStatus != STATUS_MOVING && currentStatus != STATUS_NORMAL)//自己修改：add && currentStatus != STATUS_NORMAL
                    return super.onTouchEvent(ev);
